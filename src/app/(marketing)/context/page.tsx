    ...
    <article className="mx-auto w-full max-w-4xl space-y-12 px-4 py-16 text-on-surface">
      <header className="space-y-4 text-balance">
        ...
        <p className="text-lg text-on-surface/80">
          These notes summarize what neighbours, outreach teams, and partner agencies surfaced while shaping STEVI, the shared coordination system backing every IHARC plan.
        </p>
      </header>
