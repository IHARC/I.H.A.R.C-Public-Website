...
export function TopNavMobile({ links }: TopNavMobileProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent
        side="left"
        className="flex h-full w-[min(20rem,100vw)] flex-col gap-6 border-none bg-surface px-5 py-6 text-on-surface"
      >
