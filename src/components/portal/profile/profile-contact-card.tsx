  ...
  return (
    <section className="grid gap-6 rounded-2xl border border-outline/20 bg-surface p-6 shadow-subtle">
      <div className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">Contact details</h2>
        <p className="text-sm text-on-surface/70">
          Share how moderators can follow up about petition delivery or idea moderation. Add whichever contact method
          works best for you.
        </p>
      </div>
      ...
      <form action={emailFormAction} className="grid gap-3">
        <div className="grid gap-2">
          ...
          <p className="text-xs text-muted">
            We send verification and password reset links to this address. Leave blank if you prefer phone updates only.
          </p>
        </div>
      ...
      <form action={phoneFormAction} className="grid gap-3">
        ...
        <div className="grid gap-2">
          ...
          />
          <p className="text-xs text-muted">
            Include your country code so we can text verification or urgent moderation updates.
          </p>
        </div>
